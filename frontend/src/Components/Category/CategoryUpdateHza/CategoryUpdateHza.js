...
import CategoryNavHza from "../CategoryNavHza/CategoryNavHza"; // Import the navigation component
...
function CategoryUpdateHza() {
  ...
  const validateInputs = (name, value) => {
    ...
    // Validate WasteType must be 'Hazardous'
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between bg-gray-100">
      <CategoryNavHza /> {/* Add the navigation bar */}
