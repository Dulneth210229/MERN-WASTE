...
import { FaUser, FaTruck, FaClipboardList, FaMapMarkerAlt, FaTrash, FaCog } from 'react-icons/fa';
    ...
    <div className="min-h-screen flex flex-col bg-gray-100">
      ...
      <div className="flex-grow flex items-center justify-center">
        <div className="grid grid-cols-2 gap-6 w-full max-w-4xl p-6">
          <Link to="/WCMUser_Details" className="flex items-center bg-lime-700 text-white p-6 rounded-lg hover:bg-lime-600">
            <FaUser className="mr-4 text-4xl" />
            User Details
          </Link>
          
          <Link to="/WCMDriver_Details" className="flex items-center bg-lime-700 text-white p-6 rounded-lg hover:bg-lime-600">
          ...
          <Link to="/WCMBin_Details" className="flex items-center bg-lime-700 text-white p-6 rounded-lg hover:bg-lime-600">
            <FaTrash className="mr-4 text-4xl" />
            Bin Details
          </Link>
          
          <Link to="/WCMAdmin_Details" className="flex items-center bg-lime-700 text-white p-6 rounded-lg hover:bg-lime-600">
