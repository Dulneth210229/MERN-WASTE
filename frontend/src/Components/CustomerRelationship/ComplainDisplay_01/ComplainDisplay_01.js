...
function ComplainDisplay_01() {
  ...
  return (
    <div className="form-container">
        ...
        <table className="border-2 mx-auto">
          <thead>
            <tr className="bg-green-200">
              ...
              <th className="border-2 p-2 w-24 border-green-500">Complain Category</th>
              <th className="border-2 p-2 w-20 border-green-500">Description</th>
              <th className="border-2 p-2 w-20 border-green-500">Attachments</th>
      ...
      <button onClick={handlePrint} className="mt-4 px-4 py-2 bg-green-600 text-white font-semibold rounded-lg shadow-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-opacity-75">Download Complain Report</button>
    </div>
  );
}
